...
@section('main')
    <form action="{{ route('subjects.update',['subject'=>$sub->id])}}" method="POST">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ $sub->subject_name }}" name="subject_name" class="form-control">
                            @error('subject_name')
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $sub->description }}" name="description" class="form-control">
                        @error('description')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
